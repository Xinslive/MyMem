...
assertSchemaDefault("memoryReflection.errorReminderMaxEntries", 0);
schemaAt("memoryReflection.dbPath");
assertSchemaDefault("feedbackLoop.preventiveLessons.enabled", true);
assertSchemaDefault("feedbackLoop.preventiveLessons.fromErrors", false);
...
assertSchemaDefault("hookEnhancements.toolErrorPlaybook", false);
