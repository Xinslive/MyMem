...
export class AdmissionController {
  private adaptiveTypePriors: AdmissionTypePriors | null = null;
  ...
  /** Set adaptive type priors from the feedback loop. When set, overrides config.typePriors in evaluate(). */
  setAdaptiveTypePriors(priors: AdmissionTypePriors): void {
    this.adaptiveTypePriors = { ...priors };
  }
  ...
  async evaluate(params: {
    ...
    const typePrior = scoreTypePrior(params.candidate.category, this.adaptiveTypePriors ?? this.config.typePriors);
