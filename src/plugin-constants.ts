...
export const DEFAULT_REFLECTION_AGENT_ID = "cron";
export const DEFAULT_REFLECTION_FALLBACK_AGENT_ID = "main";
export const INTERNAL_REFLECTION_ENV_FLAG = "MYMEM_INTERNAL_REFLECTION_RUN";
export const DEFAULT_REFLECTION_ERROR_REMINDER_MAX_ENTRIES = 0;
