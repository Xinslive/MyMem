...
export function buildDropSummary(
  ...
  const stageDrops = [
    ...
    {
      order: 8,
      stage: "candidateCap" as const,
      before: diagnostics.stageCounts.afterDiversity,
      after: diagnostics.stageCounts.afterCandidateCap,
    },
    {
      order: 9,
      stage: "softMinScore" as const,
      before: diagnostics.stageCounts.afterCandidateCap,
      after: diagnostics.stageCounts.afterSoftMinScore,
    },
    {
      order: 10,
      stage: "rerank" as const,
      before: diagnostics.stageCounts.afterSoftMinScore,
